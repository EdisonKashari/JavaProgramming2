...
// 1.1 Create a a data structure that can contain all the given maps above
        for (Map<String, String> names : array) {
            for (Map.Entry<String, String> eachnames : names.entrySet()) {
                System.out.println(eachnames.getKey());
            }
        }
        System.out.println("---------------------------------------------------------------------");
        // 1.2 Print the names of all scrum masters
        for (Map<String, String> names : array) {
            for (Map.Entry<String, String> pairs : names.entrySet()) {
