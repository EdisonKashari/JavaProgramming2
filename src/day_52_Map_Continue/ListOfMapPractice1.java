        ...
        for (Map<String, String> eachscrumTeam : scrumTeams) {
         ...
         /*   for (String name : eachscrumTeam.keySet()) {
                ...
                if (eachscrumTeam.get(name).equals("SM")){
                    System.out.println("All the scrum Master : "+name);
                }
            }

          */

            for (Map.Entry<String, String> pairs : eachscrumTeam.entrySet()) {
                if (pairs.getValue().equals("SM")){
                    System.out.println("pairs.getKey() = " + pairs.getKey());
                }

                if (pairs.getValue().equals("Developer")){
                    System.out.println("All the Developers : "+pairs.getKey());
                }
            }
